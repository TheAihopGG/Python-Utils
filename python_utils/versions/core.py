...
class Core:
    version_pattern = re.compile(
        "^(?P<major>[0-9]+)\.(?P<minor>[0-9]+)\.(?P<patch>[0-9]+(?P<string_part>[a-zA-Z]+))"
    )
    ...
    class Version:
        ...
        @staticmethod
        def from_string(string: str) -> Core.Version:
            if parsed_string := Core.version_pattern.search(string):
                return Core.Version(
        ...
        # operator overrides
        def __eq__(self, version: Any | Core.Version) -> bool:
            if isinstance(version, Core.Version):
                return (
        ...
        def __ge__(self, version: Any | Core.Version) -> bool:
            if isinstance(version, Core.Version):
                return any(
                    (
                        self.major >= version.major,
        ...
        def __gt__(self, version: Any | Core.Version) -> bool:
            if isinstance(version, Core.Version):
                return any(
                    (
                        self.major > version.major,
        ...
        def __le__(self, version: Any | Core.Version) -> bool:
            if isinstance(version, Core.Version):
                return any(
                    (
                        self.major <= version.major,
        ...
        def __lt__(self, version: Any | Core.Version) -> bool:
            if isinstance(version, Core.Version):
                return any(
                    (
                        self.major < version.major,
